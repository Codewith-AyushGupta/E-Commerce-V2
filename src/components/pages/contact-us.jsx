...
import contact2 from './media/contact2.jpg'
import contact3 from './media/contact3.jpg'
...
function ContactUs () {
    ...
    return (
        <main className="main contact-us">
            ...
            <div className="page-header" style={ { backgroundImage: `url(${banner})`, backgroundColor: "#92918f" } }>
