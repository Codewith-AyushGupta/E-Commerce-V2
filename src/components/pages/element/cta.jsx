...
import ElementsList from './partials/ElementsList';
import banner from './media/image.png'
import banner2 from './media/call-6.png'
        ...
        <>
            ...
            <div className="page-content">
                ...
                <section className="mt-10 pt-4">
                    ...
                    <div className="banner banner-background parallax text-center" style={ { backgroundImage: `url(${banner2})` } }>
                        <div className="container">
                            <div className="banner-content">
