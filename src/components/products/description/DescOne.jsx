...
function DescOne( props ) {
    ...
    if ( product[0].variants.length > 0 ) {
        if ( product[0].variants[ 0 ].size )
            product[0].variants.forEach( item => {
                if ( sizes.findIndex( size => size.name === item.size.name ) === -1 ) {
                    sizes.push( { name: item.size.name, value: item.size.size } );
                }
            } );

        if ( product[0].variants[ 0 ].color ) {
            product[0].variants.forEach( item => {
    ...
    return (
        <Tabs className="tab tab-nav-simple product-tabs" selectedTabClassName="show" selectedTabPanelClassName="active" defaultIndex={ 0 } >
            <TabList className="nav nav-tabs justify-content-center" role="tablist">
                ...
                <Tab className="nav-item">
                    <span className="nav-link">Reviews ({ product[0].reviews })</span>
                </Tab>
            </TabList>
                    ...
                    <div className="row mt-6">
                        ...
                        <div className="col-md-6 pl-md-6 pt-4 pt-md-0">
                            ...
                            <figure className="p-relative d-inline-block mb-2">
                                <img src="./images/product[0].jpg" width="559" height="370"
                                    alt="Product" />
                ...
                <TabPanel className="tab-pane product-tab-shipping-returns">
                    ...
                    the delivery options we offer, please view our
                            ...
                            className="text-primary">&nbsp;Delivery
										information</ALink> We hope you’ll love every
									purchase, but if you ever need to return an item you can do so within a month of
									receipt. For full details of how to make a return, please view our <ALink href="#"
                            className="text-primary">Returns information</ALink>
                    </p>
                </TabPanel>
                                            ...
                                            <div className="comment-body">
                                                <div className="comment-rating ratings-container mb-0">
                                                    <div className="ratings-full">
                                                        <span className="ratings" style={ { width: product[0].ratings * 20 + '%' } }></span>
                                                        <span className="tooltiptext tooltip-top">{ toDecimal( product[0].ratings ) }</span>
                                                    </div>
                                                </div>
                    ...
                    <div className="reply">
                        <div className="title-wrapper text-left">
                            <h3 className="title title-simple text-left text-normal">
                                {
                                    product[0].reviews > 0 ? "Add a Review" :
                                        "Be The First To Review “" + product[0].name + "”"
                                }
                            </h3>
