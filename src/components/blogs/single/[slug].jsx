...
import data from '..//data/GetPost.json'
...
import avtar from '../media/image.png'
function PostSingle() {
    const loading = false;
    const error = false;
                                        ...
                                        <div className="post-details">
                                            ...
                                            <div className="post-author-detail">
                                                <figure className="author-media">
                                                    <ALink href="#">
                                                        <img src={avtar} alt="avatar" width="50" height="50" />
                                                    </ALink>
                                                </figure>
                                                    ...
                                                    <li>
                                                        <div className="comment">
                                                            <figure className="comment-media">
                                                                <ALink href="#">
                                                                    <img src={avtar} alt="avatar" width="100" height="100" />
                                                                </ALink>
                                                            </figure>
