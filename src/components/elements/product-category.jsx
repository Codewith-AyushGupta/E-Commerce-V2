...
import { mainSlider5, mainSlider6, mainSlider9, mainSlider12 } from '../owl-carousel/data/carousel';
import media from './media/cat-2-150x150.jpg'
import media2 from './media/cat-1.jpg'
function Cta() {
    return (
        <>
            <Helmet>
                            ...
                            <div className="category category-ellipse">
                                <ALink href="#">
                                    <figure className="category-media">
                                        ...
                                        <img src={media2} alt="Cateogry" width="196" height="196" />
                                    </figure>
                                </ALink>
                    ...
                    <section className="mt-10 pt-4">
                        ...
                        <OwlCarousel adClass="owl-theme" options={ mainSlider5 }>
                            <div className="category category-absolute category-classic">
                                <figure className="category-media">
                                    <img src={media2} alt="Cateogry" width="280"
                                        height="280" />
                                </figure>
                                <div className="category-content">
